...
class ContentTemplate extends SerializedContent
{
    ...
    /** @var StringTextField    Selector for a DOM element containing the content generated by this template. */
    ...
    /**
     * Format the full path to the template file as a convenience, pointing it at
     * either the common directory or local depending on the "location" value.
     * @return string Full path to the template file, taking into account if the location is set to the shared location or the local location.
    ...
    {
        return $this->wildcard->formatValueMarkup();
    }
    ...
    public function hydrateFromRecordsetRow(object $row): void
    {
        ...
        if ($this->hydrate_extras) {
            // "id" field is normally ignored but is needed when retrieving records using unique index fields values
     ...
     * @return string Name of the content type matching the object's content_type_id property value
     * @throws ConfigurationUndefinedException
