...
class FilterCollection extends FilterCollectionProperties
{
     ...
     */
    public function preserveInForm(?array $exclude = null): void
    {
     ...
     * @return void
     */
    protected function restorePaginationValues(PaginationValues $values): void
    {
     ...
     * @return void
     */
    public static function setAutoloadDefault(bool $autoload): void
    {
     ...
     * @return void
     */
    protected function setNeighborIdsFromListingsData(array $data, int $page_position): void
    {
        if ($page_position > 1) {
