...
{
	const PAGE_FORWARD = "fwd";
	const PAGE_BACK = "back";
	const ID_PARAM = "id";
	const BOOK_PARAM = "b";
	const PAGE_PARAM = "p";
	...
	public static $viewer_uri = '';
	public static $one_page_layout = '1-up';
	public static $two_page_layout = '2-up';

	/**
	 * AlbumViewer constructor
	 * @param int $content_type_id
	 * @param int $page_content_content_id
	 ...
	 */
	function __construct($content_type_id, $page_content_content_id, $image_dir )
	{
		parent::__construct($content_type_id, $page_content_content_id);
