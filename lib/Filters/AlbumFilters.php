...
class AlbumFilters extends ContentFilters
{
    ...
    /** @var DateContentFilter $release_after Filters out records with release dates before the value of this property. */
    public DateContentFilter $release_after;
    /** @var DateContentFilter $release_before Filters out records with release dates after the value of this property. */
    public DateContentFilter $release_before;
    ...
    /**
     * @deprecated Use a stored procedure instead.
     * Returns a select portion of SQL statement to retrieve album listings.
     */
    ...
    /**
     * Retrieves from a database the uri of the page used to display details for this content type.
     ...
     * @return string String containing a JavaScript array.
     */
    ...
    public function prepareListingsContext(string $url, string $query_string): array
    {
        $context = array(
            ...
            'keywords' => new KeywordSectionContent(null, $this->getContentTypeId()),
            'data' => array());
    ...
    public function retrieveKeywordSearchResults(): array
    {
        ...
        /* get a record count from procedure results */
