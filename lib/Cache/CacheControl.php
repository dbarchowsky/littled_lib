...
class CacheControl
{
    ...
    /** @var CacheControlType|null Object representing the cache controls for the requested file type. */
    public CacheControlType|null $cacheType;
    /** @var array|null List of allowed file extensions (as keys) assosiated with their mime types (as values). */
    public static array|null $allowedTypes = null;
     ...
     */
    #[NoReturn] public static function exitWith400(string $msg): void
    {
     ...
     */
    #[NoReturn] public static function exitWith404(): void
    {
     ...
     * @throws ResourceNotFoundException
     */
    public function validateAsset(): void
    {
     ...
     * @throws ContentValidationException
     */
    public function validateFileType(): void
    {
