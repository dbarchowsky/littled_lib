...
class LoginAuthenticator extends UserLogin
{
    ...
    /**
     * Verifies login credentials using internal values of the login object.
     ...
     */
    public function collectRedirectURI(): void
    {
     ...
     */
    public function requireLogin(int $access_level = 100, string $msg = ''): void
    {
     ...
     * @return void
     */
    public function validateOnSession(int $accessLevel = 100): void
    {
