...
class Debug
{
     ...
     */
    #[NoReturn]
    public static function inspectAsJSON(mixed $var): void
    {
     ...
     * @param string $status Status of a message.
    ...
    /**
     * Prints a formatted debugging message to the browser.
     ...
     */
    #[NoReturn]
    public static function stopScript(
        string $debug_msg = '',
