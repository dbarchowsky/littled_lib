...
CREATE OR REPLACE PROCEDURE `gallerySelect`(
    IN p_parent_id INT,
...
BEGIN
    ...
    SELECT
        ...
        l.page_number,
        l.access,
        DATE_FORMAT(l.release_date, '%c/%e/%Y') AS `release_date`,
        full.id full_id,
        full.path full_path,
    ...
    ORDER BY IFNULL(l.page_number,999999), IFNULL(l.slot,999999), l.id;
