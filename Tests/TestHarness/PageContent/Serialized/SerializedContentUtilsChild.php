...
class SerializedContentUtilsChild extends SerializedContentChild
{
	...
	/** @var TestTableSerializedContentTestHarness[] Array of linked SerializedContent records */
    ...
    public function __construct()
    {
		...
		$this->child_array[] = new TestTableSerializedContentTestHarness(88, 'First test child');
	    $this->child_array[] = new TestTableSerializedContentTestHarness(99, '2nd test child', 854, true, '2022-02-10', 4);
    }
}